...
var file_User_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x22, 0x28, 0x0a, 0x0b, 0x55, 0x73, 0x65, 0x72, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73,
	0x74, 0x12, 0x19, 0x0a, 0x08, 0x75, 0x73, 0x65, 0x72, 0x5f, 0x69, 0x64, 0x73, 0x18, 0x01, 0x20,
	0x03, 0x28, 0x05, 0x52, 0x07, 0x75, 0x73, 0x65, 0x72, 0x49, 0x64, 0x73, 0x22, 0x34, 0x0a, 0x0c,
	...
	0x73, 0x65, 0x72, 0x73, 0x2f, 0x7b, 0x75, 0x73, 0x65, 0x72, 0x5f, 0x69, 0x64, 0x73, 0x7d, 0x12,
	0x4c, 0x0a, 0x19, 0x47, 0x65, 0x74, 0x55, 0x73, 0x65, 0x72, 0x49, 0x6e, 0x66, 0x6f, 0x42, 0x79,
	0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x12, 0x15, 0x2e, 0x73,
	...
	0x73, 0x65, 0x72, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x30, 0x01, 0x12, 0x4c, 0x0a,
	0x19, 0x47, 0x65, 0x74, 0x55, 0x73, 0x65, 0x72, 0x49, 0x6e, 0x66, 0x6f, 0x42, 0x79, 0x43, 0x6c,
...
var file_User_proto_depIdxs = []int32{
	2, // 0: services.UserResponse.users:type_name -> services.User
...
func (c *userServiceClient) GetUsersInfo(ctx context.Context, in *UserRequest, opts ...grpc.CallOption) (*UserResponse, error) {
	out := new(UserResponse)
	err := c.cc.Invoke(ctx, "/services.UserService/GetUsersInfo", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *userServiceClient) GetUserInfoByServerStream(ctx context.Context, in *UserRequest, opts ...grpc.CallOption) (UserService_GetUserInfoByServerStreamClient, error) {
	stream, err := c.cc.NewStream(ctx, &_UserService_serviceDesc.Streams[0], "/services.UserService/GetUserInfoByServerStream", opts...)
	if err != nil {
		return nil, err
	}
...
func (x *userServiceGetUserInfoByServerStreamClient) Recv() (*UserResponse, error) {
	m := new(UserResponse)
...
func (c *userServiceClient) GetUserInfoByClientStream(ctx context.Context, opts ...grpc.CallOption) (UserService_GetUserInfoByClientStreamClient, error) {
	stream, err := c.cc.NewStream(ctx, &_UserService_serviceDesc.Streams[1], "/services.UserService/GetUserInfoByClientStream", opts...)
	if err != nil {
		return nil, err
	}
...
func (x *userServiceGetUserInfoByClientStreamClient) Send(m *UserRequest) error {
	return x.ClientStream.SendMsg(m)
}

func (x *userServiceGetUserInfoByClientStreamClient) CloseAndRecv() (*UserResponse, error) {
	if err := x.ClientStream.CloseSend(); err != nil {
		return nil, err
	}
	m := new(UserResponse)
...
func (*UnimplementedUserServiceServer) GetUsersInfo(context.Context, *UserRequest) (*UserResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetUsersInfo not implemented")
}
func (*UnimplementedUserServiceServer) GetUserInfoByServerStream(*UserRequest, UserService_GetUserInfoByServerStreamServer) error {
...
func _UserService_GetUsersInfo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/services.UserService/GetUsersInfo",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).GetUsersInfo(ctx, req.(*UserRequest))
	}
...
func (x *userServiceGetUserInfoByServerStreamServer) Send(m *UserResponse) error {
...
func (x *userServiceGetUserInfoByClientStreamServer) SendAndClose(m *UserResponse) error {
	return x.ServerStream.SendMsg(m)
}

func (x *userServiceGetUserInfoByClientStreamServer) Recv() (*UserRequest, error) {
	m := new(UserRequest)
